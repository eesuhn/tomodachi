...
("Donut", "Circular pastry with a hole in center, sweet, glazed or sprinkled topping.", 
...
("Strawberry", "Small, juicy, red fruit with sweet and tangy taste.", 
...
("Capybara", "Legendary", 
"This gentle giant is the king of chill! They love lounging in the sun and taking dips in the water. With their friendly nature, they're a unique personality to raised.", "../assets/pets/capybara.png"),
("Cat", "Common", 
...
("Dog", "Common", 
"This loyal pup loves nothing more than playing fetch and cuddling up with their owner. With their wagging tail and loyalty, they're your new best friend!", "../assets/pets/dog.png"),
("Raccoon", "Rare", 
...
("Sky", "A gradient of blue hues that evoke feelings of peace.", 0, "../assets/wallpapers/sky.png"),
("Meadow", "A serene landscape of gently swaying grasses and wildflowers.", 250, "../assets/wallpapers/meadow.png"),
...
("Campfire", "A warm and flickering fire that conjures up images of camping trips.", 250, "../assets/wallpapers/campfire.png"),
...
("Starry Nights", "A stunning night sky filled with twinkling stars", 500, "../assets/wallpapers/starrynight.png");
