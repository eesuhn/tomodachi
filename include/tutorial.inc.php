...
<div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button class="btn btn-dark" data-bs-target="#tutorial1" data-bs-toggle="modal">No, bring me back</button>
      </div>
    </div>
  </div>
</div>
...
<div class="modal fade" id="tutorial9" aria-hidden="true" tabindex="-1" data-bs-keyboard="false" data-bs-backdrop="static">
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        <button class="btn btn-secondary" data-bs-target="#tutorial1" data-bs-toggle="modal" style="left:0; position: absolute;">Back to first</button>
        <button class="btn btn-primary" data-bs-target="#tutorial10" data-bs-toggle="modal">Next</button>
        <button class="btn btn-dark" data-bs-target="#tutorial8" data-bs-toggle="modal">Back</button>
      </div>
    </div>
  </div>
</div>

<div class="modal fade" id="tutorial10" aria-hidden="true" tabindex="-1" data-bs-keyboard="false" data-bs-backdrop="static">
  <div class="modal-dialog modal-dialog-centered modal-lg">
    <div class="modal-content">
      <div class="modal-body">
        <center>
